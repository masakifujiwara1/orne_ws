...
class deep_learning:
	...
	def save(self):
		chainer.serializers.save_npz('/home/orne_box/orne_ws/src/obstacle_avoidance/net_models/tsudanuma_round_7.net', self.net)

	def load(self):
		chainer.serializers.load_npz('/home/orne_box/orne_ws/src/obstacle_avoidance/net_models/model_shuff3_b8.net', self.net)
