...
#		self.nav_pub = rospy.Publisher('/learning_vel', Twist, queue_size=10)
	...
	def loop(self):
		...
		if self.visual_run:
			...
			print("Visual RUN: " + " angle_error:" + str(self.angle_error) + " covariance:" + str(self.cov))
			line = [str(self.step), "test", str(self.cov), str(self.angle_error), str(self.pose_x), str(self.pose_y)]
			...
			print("NAVIGATION: " + " angle_error:" + str(self.angle_error) + " covariance:" + str(self.cov))
